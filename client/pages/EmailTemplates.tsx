    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          <Button onClick={handleExportTemplates} className="macos-button text-[#1D1D2C]">
            <Download className="mr-2 h-4 w-4" />
            Export Templates
          </Button>
          <Button onClick={handleNewTemplate} className="bg-gradient-to-r from-[#2C8780] to-[#72F1DC] text-white hover:scale-105 transition-all duration-300" style={{
            boxShadow: '0 4px 12px rgba(44, 135, 128, 0.3)'
          }}>
