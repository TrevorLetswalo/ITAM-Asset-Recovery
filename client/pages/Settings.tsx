...
function GeneralSettings() {
  ...
  return (
    <div className="space-y-6">
      <CleanContainer>
        <h3 className="text-lg font-medium text-oxford-blue mb-4">
      ...
      <CleanContainer>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-oxford-blue">
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              description: "Immediate alerts when SLAs are breached",
            },
            {
              key: "escalationAlerts",
              label: "Escalation Notifications",
              description: "Alerts when cases are escalated",
            },
            {
              key: "weeklyReports",
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-hippie-blue">
            Configure your IT Asset Recovery Console preferences
          </p>
        </div>
      ...
      <Tabs defaultValue="general" className="space-y-6">
        <CleanContainer className="p-0">
          <TabsList
            className="w-full p-1 grid grid-cols-3"
            style={{
